  ...
  ${frame.code}`;
    ...
    "8lqZg": [
      function (require, module, exports) {
        ...
        var _onDemandLiveRegion = require("on-demand-live-region");
        var _onDemandLiveRegionDefault =
          parcelHelpers.interopDefault(_onDemandLiveRegion);
        var _focusOptionsPolyfill = require("focus-options-polyfill");
        class SwupA11yPlugin extends (0, _pluginDefault.default) {
          name = "SwupA11yPlugin";
          constructor(options = {}) {
            super();
            this.options = {
            ...
            this.liveRegion = new (0, _onDemandLiveRegionDefault.default)();
          }
          mount() {
          ...
          announcePageName = () => {
            ...
            let pageName = urlTemplate.replace(
              "{url}",
              window.location.pathname
            );
            // Check for title tag
            if (document.title) pageName = document.title;
            ...
            const announcement = announcementTemplate.replace(
              "{title}",
              pageName.trim()
            );
      ...
      {
        "@swup/plugin": "fzCtG",
        "on-demand-live-region": "3VLy0",
        "focus-options-polyfill": "fXfS2",
        "@parcel/transformer-js/src/esmodule-helpers.js": "5DFUJ",
      },
    ],
    fzCtG: [
      function (require, module, exports) {
        ...
        const r = (r) =>
          String(r).split(".").concat(["0", "0"]).slice(0, 3).join(".");
        class e {
          constructor() {
            (this.isSwupPlugin = !0),
              (this.requires = {}),
          ...
          _checkRequirements() {
            return (
              "object" != typeof this.requires ||
                Object.entries(this.requires).forEach((e) => {
                  let [n, t] = e;
                  if (
      ...
      function (require, module, exports) {
        /* global define */ (function (global) {
          ...
          OnDemandLiveRegion.prototype.say = function (thingToSay, delay) {
            ...
            if (oldRegion) this.settings.parent.removeChild(oldRegion);
