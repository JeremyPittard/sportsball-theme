      ...
      var d = (function (e) {
        ...
        function t() {
          ...
          n.stopShowingProgress = function () {
            ...
            if (n.options.hideImmediately) {
              n.hideProgressBar();
            } else {
              n.finishAnimationAndHideProgressBar();
            }
          };
          ...
          n.showProgressBarAfterDelay = function () {
            ...
            n.cancelHideProgressBarTimeout();
            n.showProgressBarTimeout = window.setTimeout(
              n.showProgressBar,
              n.options.delay
            );
          };
          ...
          n.finishAnimationAndHideProgressBar = function () {
            n.cancelShowProgressBarTimeout();
            n.hideProgressBarTimeout = window.setTimeout(
              n.hideProgressBar,
              n.options.transition
            );
          };
          n.cancelShowProgressBarTimeout = function () {
            window.clearTimeout(n.showProgressBarTimeout);
            delete n.showProgressBarTimeout;
          };
          n.cancelHideProgressBarTimeout = function () {
            window.clearTimeout(n.hideProgressBarTimeout);
            delete n.hideProgressBarTimeout;
          };
          var i = {
          ...
          n.options = r({}, i, e);
          n.showProgressBarTimeout = null;
          n.hideProgressBarTimeout = null;
          n.progressBar = new u.default({
            className: n.options.className,
            animationDuration: n.options.transition,
            minValue: n.options.minValue,
            initialValue: n.options.initialValue,
          });
          return n;
        }
        i(t, [
      ...
      var o = (function () {
        function e() {
          ...
          var n =
              arguments.length > 0 && arguments[0] !== undefined
                ...
                : {},
            r = n.className,
            o = r === undefined ? "progress-bar" : r,
            s = n.styleAttr,
            a = s === undefined ? "data-progressbar-styles" : s,
            u = n.animationDuration,
            l = u === undefined ? 300 : u,
            f = n.minValue,
            c = f === undefined ? 0.1 : f,
            h = n.initialValue,
            d = h === undefined ? 0.25 : h,
            m = n.trickleValue,
            p = m === undefined ? 0.03 : m;
          i(this, e);
          ...
          this.trickle = function () {
            var e = Math.random() * t.trickleValue;
            t.setValue(t.value + e);
          };
          this.className = o;
          this.styleAttr = a;
        ...
        r(e, [
          ...
          },
          {
            key: "setValue",
            value: function e(t) {
              this.value = Math.min(1, Math.max(this.minValue, t));
              this.refresh();
            },
          },
          {
          ...
          },
          {
            ...
            value: function e() {
              ...
              requestAnimationFrame(function () {
                t.progressElement.style.width = t.value * 100 + "%";
              });
            },
          },
          {
